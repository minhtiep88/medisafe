...
import { LucideAlertCircle, LucideCopy, LucideCopyCheck, LucideDownload } from "lucide-react";
import { useState } from "react";

export default function NewPhrase() {
  const [phrase, setPhrase] = useState(
    "hello world helleoworld hello world hello world hello world hello world hellowolrd"
  );
  ...
  return (
    <div className="flex justify-center items-center h-full">
      <div className="flex flex-col gap-4 rounded-md p-4 border-2 w-[400px]">
